...
def convert_and_upload_supervisely_project(
    ...
    dataset_path = "/Users/iwatkot/Downloads/ninja/datasets/accurate_nevus_shapes"
    ds_name = "ds"
    batch_size = 30

    images_folder_name = "720p"
    ...
    def create_ann(image_path):
        ...
        mask_path = os.path.join(masks_path, masks_prefix + image_name + masks_ext)
    ...
    obj_class = sly.ObjClass("nevus", sly.Bitmap)
